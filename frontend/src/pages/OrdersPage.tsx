...
import { ArrowUpDown, ChevronDown, MoreHorizontal, Search, ListRestart, LogIn, ShieldAlert } from "lucide-react"
import {
    Dialog,
    DialogContent,
    DialogHeader,
...
export default function OrdersPage() {
    ...
    const table = useReactTable({
        ...
        globalFilterFn: (row, _columnId, filterValue) => {
            ...
            return id.includes(searchValue) || status.includes(searchValue);
        },
        state: {
            sorting,
            columnFilters,
                    ...
                    <DialogContent className="sm:max-w-[425px]">
                        ...
                        <div className="pt-4 mt-2 border-t">
                            <Button asChild className="w-full">
                                <Link to={`/orders/${viewingOrder?.id}`}>View order items</Link>
                            </Button>
                        </div>
                    </DialogContent>
                </Dialog>
